...
const InvoiceModal: FC<InvoiceModalProps> = ({ isOpen, onClose, onSave, cases }) => {
    ...
    useEffect(() => {
        if (formData.caseId) {
            const generatedId = `FACT-${formData.caseId}-${Date.now().toString().slice(-5)}`;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-white rounded-lg shadow-2xl p-8 max-w-2xl w-full">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Enregistrer une facture</h2>
