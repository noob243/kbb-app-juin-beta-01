            ...
            <div className="bg-white rounded-lg shadow-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            <label className="block text-sm font-semibold text-gray-750 mb-1">Sélectionner un client <span className="text-red-500">*</span></label>
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-750 mb-1">ID Dossier (généré automatiquement)</label>
                            <input type="text" name="dossierId" placeholder="Sélectionnez un client d'abord" value={formData.dossierId} className="w-full p-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 font-mono text-indigo-700 font-bold" readOnly />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-gray-750 mb-1">Nom du dossier <span className="text-red-500">*</span></label>
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-750 mb-1">Date de création</label>
                        ...
                        <div className="md:col-span-2 bg-slate-50/50 p-3.5 rounded-xl border border-slate-200">
                            <label className="block text-sm font-semibold text-gray-750 mb-1">Adversaires (Plusieurs possibles)</label>
                            <div className="flex gap-2 mb-2">
                                <input 
                                    ...
                                    className="flex-1 p-2 border border-gray-300 rounded-lg shadow-inner text-sm focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all bg-white"
                                />
                                <button 
                                    type="button" 
                                    onClick={() => handleAddAdversary()}
                                    className="bg-[#15447c] hover:bg-[#15447c]/90 text-white font-bold py-2 px-4 rounded-lg text-xs transition shrink-0"
                                >
                                    Ajouter
                                </button>
                            </div>
                            {formData.adversaires && formData.adversaires.length > 0 ? (
                                <div className="flex flex-wrap gap-1.5 p-2 bg-white border border-slate-200 rounded-lg">
                                    {formData.adversaires.map(adv => (
                                        <span 
                                            key={adv}
                                            className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-50 text-red-800 font-bold text-xs border border-red-100"
                                        >
                                            {adv}
                                            <button 
                                                type="button"
                                                onClick={() => handleRemoveAdversary(adv)}
                                                className="text-red-500 hover:text-red-750 font-bold text-xs hover:bg-red-100 rounded px-1"
                                            >
                                                ×
                                            </button>
                                        </span>
                                ...
                                <p className="text-2xs text-gray-400 italic">Aucun adversaire ajouté pour le moment.</p>
                            )}
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-gray-750 mb-1">Objet principal</label>
