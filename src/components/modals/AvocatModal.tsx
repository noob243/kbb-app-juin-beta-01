...
const AvocatModal: FC<AvocatModalProps> = ({ isOpen, onClose, onSave }) => {
    ...
    useEffect(() => {
        if (formData.fullName) {
            ...
            const generatedId = `AVO-${finalInitials}-${digits}`;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-white rounded-lg shadow-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-black text-gray-800">Ajouter un nouvel avocat</h2>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1">Adresses E-mails</label>
                                <div className="space-y-2">
                                    <input type="email" name="email1" placeholder="E-mail principal" value={formData.email1} onChange={handleChange} className="w-full p-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/15 transition placeholder:text-gray-400" />
